...
"""
Credit: https://github.com/SCEDC/cloud/blob/master/pds_phase_download.py
"""
...
# S3 connection
s3cli = boto3.client('s3', config=botocore.config.Config(signature_version=botocore.UNSIGNED))
s3res = boto3.resource('s3', config=botocore.config.Config(signature_version=botocore.UNSIGNED))
